...
#Now we will use CascaClassifier function of cv2 for pointing out the location where we the have the file, I have downloaded it
...
#To write on site
components.html("<html><body><h3>Streamlit is an open source Python Library used to"
                    "make a web application arround your Machine learning model</h3></body></html>",
...
#st.write is used to simply write on the webpage
st.write("Name: ", t1)
st.write("Age: ", s1)
